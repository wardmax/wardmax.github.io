...
/** @type {string} */
const CACHE_VERSION = '1746545597|1578027383';
/** @type {string} */
const CACHE_PREFIX = 'BounceAndPierce-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'BounceAndPierce.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["BounceAndPierce.html","BounceAndPierce.js","BounceAndPierce.offline.html","BounceAndPierce.icon.png","BounceAndPierce.apple-touch-icon.png","BounceAndPierce.audio.worklet.js","BounceAndPierce.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["BounceAndPierce.wasm","BounceAndPierce.pck","BounceAndPierce.side.wasm"];
